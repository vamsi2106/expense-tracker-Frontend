...
//         state.page_status = pageStatusObject.error;
//         state.message =
//           (action.payload as string) || "Failed to fetch file by ID";
//       });
//   },
// });
...
import { createSlice, createAsyncThunk } from "@reduxjs/toolkit";
import { FileService } from "../../src/services/file.services"; // Import your service
import { PageStatus } from "../utils/pageStatus";
...
// Async thunk to fetch all files
export const fetchFiles = createAsyncThunk<FileDetails[], { userId: string }>(
  "files/fetchFiles",
  async ({ userId }) => {
